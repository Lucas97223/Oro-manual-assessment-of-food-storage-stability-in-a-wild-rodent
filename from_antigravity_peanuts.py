...
def plot_real_peanut_3d_surface(a=1.2602, b=1.3749, output_file=None, show=True):
    ...
    All three coordinate contours (x, y, z) are enabled with a moderate spacing (size=0.08)
    to create a clean grid of squares representing the vertices.
    ...
    # Generate the Cassini ovoid meshgrid with very high density (300x300) for tiny, square grid elements
